...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-327-erd-s-problem-327-d01c2c1a-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-327"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-327-erd-s-problem-327-d01c2c1a-v1",
      "problem_contract_sha256": "70c26eb59ffbc0ed04d59563dd0bdb6b339bb8dea36fda75fcb86ce9a6ad0bbc",
      "problem_id": "problem:um-ep-327-erd-s-problem-327-d01c2c1a",
      "route_id": "route:um-ep-327-erd-s-problem-327-d01c2c1a-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-327-erd-s-problem-327-d01c2c1a-source-fidelity-01",
      "graph_id": "graph:um-ep-327-erd-s-problem-327-d01c2c1a-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-327-erd-s-problem-327-d01c2c1a-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-327-erd-s-problem-327-d01c2c1a-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Suppose $A\\subseteq \\{1,\\ldots,N\\}$ is such that if $a,b\\in A$ and $a eq b$ then $a+b mid ab$. Can $A$ be 'substantially more' than the odd numbers? What if $a,b\\in A$ with $a eq b$ implies $a+b mid 2ab$? Must $\\lvert A\\rvert=o(N)$?"
          },
          "statement_sha256": "b666a9a8e45cfa45135fe8313ea382e4ec6d1538c56223c6ce2a12ab767a7d52"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-327-erd-s-problem-327-d01c2c1a-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-327-erd-s-problem-327-d01c2c1a-root",
      "route_id": "route:um-ep-327-erd-s-problem-327-d01c2c1a-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-327-ab35caeaf1e0",
        "url": "https://www.unsolvedmath.com/problems/EP-327"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
